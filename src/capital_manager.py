...
def calculate_investment_plan(total_budget, n_batches, analysis, evidence, is_us=True):
    ...
    for i in range(n_batches):
        target_bias = current_bias - (i * 2.0) # 階梯間距
        ...
        w_avg_cost = (accumulated_cost_twd / fx) / accumulated_shares if accumulated_shares > 0 else 0
        ...
        plan.append({
            ...
            "累積股數": accumulated_shares,
            "加權平均成本": round(w_avg_cost, 2)
        })
